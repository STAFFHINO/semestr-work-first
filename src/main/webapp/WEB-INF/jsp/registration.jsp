...
<div class="container-sm my-container">
    <form class="px-sm-1 py-sm-0 needs-validation" method="post">
        <h1>Регистрация</h1>
        <div class="md-3">
            <label for="exampleDropdownFormEmail" class="form-label">Ваш никнейм</label>
            <input type="text" class="form-control" id="exampleDropdownFormEmail" name="nickname" placeholder="nickname" required>
        </div>
        <div class="md-3">
